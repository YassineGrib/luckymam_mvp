...
## 🟡 Should Have — 10 tickets · 62 SP

| ID | Feature | SP | Phase | Statut | Fichier |
|----|---------|-----|-------|--------|---------|
| LM2-119 | Splash branding | 3 | M1-M3 | ✅ | [LM2-119.md](issues/LM2-119.md) |
| LM2-121 | Header Home — avatar agrandi | 2 | M1-M3 | ✅ | [LM2-121.md](issues/LM2-121.md) |
| LM2-125 | Graphique poids — axe 80 kg | 3 | M1-M3 | ✅ | [LM2-125.md](issues/LM2-125.md) |
...
| Phase | Tickets | SP total |
|-------|---------|----------|
| M1-M3 | LM2-118, 119, 120, 121, 123, 124, 125, 127 | 37 |
| M4-M6 | LM2-122, 126, 128, 129, 131 | 27 |
| M7-M9 | LM2-130, 132, 133 | 18 |
| M10-M12 | LM2-134, 135, 136, 137, 138, 139 | 81 |
...
Pour chaque ticket, modifier le **Statut** dans le tableau ci-dessus :
- `⬜ À faire` → `🔄 En cours` quand on commence
- `🔄 En cours` → `✅ Terminé` quand c'est fini et testé
- `🚫 Bloqué` si bloqué (préciser la raison dans le fichier issue)

Mettre à jour aussi le champ `Statut` dans le fichier `.md` correspondant dans `issues/`.
